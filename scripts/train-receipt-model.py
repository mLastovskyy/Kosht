...
SHOPS = [
    ...
    ('ООО "Хит! Экспресс"', "хит"), ("Виталюр", "виталюр"),
    ('ГИПЕРМАРКЕТ "ГРИН"', "green"), ('ТС "Соседи"', "соседи"),
    ('ООО "Грошык"', "грошык"), ('ЧТУП "Радзивилловский"', "радзивилловский"),
    ('ОАО "Верас"', "верас"), ('РУП "Белфармация" Аптека №28', "белфармация"),
    ('ООО "Материк"', "материк"), ('ООО "ОМА"', "oma"),
    ("КОРОНА ГИПЕРМАРКЕТ", "корона"), ('Магазин №147 "Алми"', "алми"),
    ('ООО "Табак-инвест" Корона', "корона"),
]
